...
__attribute__ ((constructor)) static void bfinject_rocknroll() {
    ...
    NSNumber *value = [[[NSDictionary alloc] initWithContentsOfFile:@"/var/jb/Library/MobileSubstrate/DynamicLibraries/bfdecrypt.plist"] objectForKey:bundleID];
                ...
                [alertController dismissViewControllerAnimated:NO completion:^{
                    ...
                    /*UIAlertAction *removePrefAction = [UIAlertAction actionWithTitle:@"Finish"
                        ...
                        handler:^(UIAlertAction *action) {
                            ...
                            // it's crashing, meh
                            HBPreferences *preferences = [HBPreferences preferencesForIdentifier:@"dev.und3fy.bfdecrypt"];
